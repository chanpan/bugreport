...
use backend\models\bugreport3Search;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * BugReport3Controller implements the CRUD actions for BugReport model.
 */
class BugReport3Controller extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new bugreport3Search();
